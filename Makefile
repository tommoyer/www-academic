...
.PHONY: build
build: buildCV
> podman run --volume=".:/srv/jekyll" -it docker.io/jekyll/jekyll:$(jekyll_version) jekyll build
...
.PHONY: serve
serve:
> podman run --expose 4000 -p 4000:4000 --volume=".:/srv/jekyll" -it docker.io/jekyll/jekyll:$(jekyll_version) jekyll serve
